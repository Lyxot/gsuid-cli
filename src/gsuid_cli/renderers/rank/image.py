...
def _title_stats(
    ...
    star_map = _json_map("avatarId2Star_mapping_6.7.0.json")
    ...
    return [
        ...
        f"{star5_weapon}/{len(_json_map('weaponId2Name_mapping_6.7.0.json'))}",
        high_score,
        useful,
    ]
...
def _artifact_name(artifact: Mapping[str, object]) -> str:
    ...
    mapped = _json_map("icon2Name_mapping_6.7.0.json").get(icon_key)
