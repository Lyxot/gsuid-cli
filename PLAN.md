...
- Add README quickstart focused on agents.
- Add command reference generated from capabilities metadata.
- Add credential safety guide.
- Add GitHub Actions for lint and tests.
- Add release build workflow if publishing is desired.
- Verification: fresh clone setup instructions work.
