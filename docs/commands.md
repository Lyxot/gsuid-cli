...
| `rank.artifact` | `none` | `data, image, both` | `off` | Show the Akasha global artifact leaderboard. |
| `rank.character` | `none` | `data, image, both` | `off` | Show a character Akasha leaderboard or nearby UID rank rows. |
